...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        //Ex1
        List<Product> priceOver100 = products.stream()
        ...
        Order order1 = new Order(235235L, "Shipped", LocalDate.of(2021, 2, 15), LocalDate.of(2021, 2, 17),
                List.of(bike, stroller, hp1), Alexander);
        Order order2 = new Order(325235L, "Pending", LocalDate.now(), LocalDate.now()
                .plusDays(7), List.of(cream, pacifier, hp2), Martina);
        Order order3 = new Order(5235232L, "Out for delivery", LocalDate.now(), LocalDate.now(), List.of(hp3, bike),
                Paolone);
        ...
        //Ex3
        List<Product> boys10 = products.stream()
                .filter(product -> product.getCategory()
                        .equals("Boys"))
        ...
        List<Product> tier2Products = orders.stream()
                .filter(order -> order.getCustomer()
                        ...
                        .isBefore(LocalDate.of(2021, 2, 1)) && !order.getOrderDate()
                        .isAfter(LocalDate.of(2021, 4, 1)))
        ...
        //Ex2.0
        Map<Customer, Double> totalSales = orders.stream()
                .collect(Collectors.groupingBy(Order::getCustomer, Collectors.summingDouble(Order::total)));
